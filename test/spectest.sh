...
##
    ...
    ./spectest -a -"$AFPVERSION" -h "$AFPSERVER" -p "$AFPPORT" -u "$USER1" -w "$PASSWD" -s "$VOLUME" -c "$LOCALVOLPATH" > spectest.log
    check_return

##
    printf "Running spectest with two user ..."
    ./spectest -a -"$AFPVERSION" -h "$AFPSERVER" -p "$AFPPORT" -u "$USER1" -d "$USER2" -w "$PASSWD" -s "$VOLUME" -c "$LOCALVOLPATH" >> spectest.log
    check_return

##
    printf "Running spectest with local filesystem modifications..."
    ./T2_spectest -a -"$AFPVERSION" -h "$AFPSERVER" -p "$AFPPORT" -u "$USER1" -d "$USER2" -w "$PASSWD" -s "$VOLUME" -c "$LOCALVOLPATH" >> spectest.log
    check_return
...
##
    printf "Running spectest with one user ..."
    ./spectest -"$AFPVERSION" -h "$AFPSERVER" -p "$AFPPORT" -u "$USER1" -w "$PASSWD" -s "$EA_VOLUME" -c "$EA_LOCALVOLPATH" > spectest.log
    check_return

##
    printf "Running spectest with two user ..."
    ./spectest -"$AFPVERSION" -h "$AFPSERVER" -p "$AFPPORT" -u "$USER1" -d "$USER2" -w "$PASSWD" -s "$EA_VOLUME" -c "$EA_LOCALVOLPATH" >> spectest.log
    check_return

##
    printf "Running spectest with local filesystem modifications..."
    ./T2_spectest -"$AFPVERSION" -h "$AFPSERVER" -p "$AFPPORT" -u "$USER1" -d "$USER2" -w "$PASSWD" -s "$EA_VOLUME" -c "$EA_LOCALVOLPATH" >> spectest.log
    check_return
